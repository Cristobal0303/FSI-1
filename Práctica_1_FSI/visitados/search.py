...
def graph_search(problem, fringe):
    ...
    closed = {}
    fringe.append(Node(problem.initial))    # Añadimos el nodo inicial
    nodos_visitados = 0    # Nº nodos visitados
    nodos_generados = 0    # Nº nodos generados
    ...
    while fringe:
        ...
        if problem.goal_test(node.state):
            ...
            nodos_generados += fringe.__len__()
...
def branch_and_bound(problem):
    return graph_search(problem, branch_and_bound_queue())

def branch_and_bound_h(problem):
    return graph_search(problem, branch_and_bound_h_queue(problem))
